        ...
        LocalNotificationManager.isAuthorized { (authorized) in
            DispatchQueue.main.async {
                if authorized == false && self.reminderSwitch.isOn {
                    self.oneButtonAlert(title: "User Has Not Allowed Notification", message: "To receive alerts for reminders, open the Settings app, select To Do List > Notifications > Allow Notifications.")
